    ...
    return (
        <div id="page-about">
            <div className="content">
                ...
                <p>Pra atingir tal objetivo, separamos o conteúdo do site em 3 categorias - não necessariamente desligadas uma da outra.</p>
                <h5>Fitness</h5>
                {/*<h5>Nutrição</h5>*/}
                <h5>Ervas Medicinais</h5>
                <h5>Beleza e Estética</h5>
                <p>Em cada categoria, dicas de produtos para contribuir com a vida de cada leitor.</p>
            </div>
        </div>
    )
}
