           ...
           <div id="product-container">
                <div id="product">
                    ...
                    <div className="more">
                        ...
                        <a href="https://app.monetizze.com.br/checkout/DNZ68690" className="redirect-button"><p>Saiba Mais</p></a>
                    </div>
                </div>
                <div id="product">
                    <h4>Detox Caps</h4>
                    ...
                    <div className="more">
                        ...
                        <a href="https://detoxcaps.com.br/?mcr=ADE8730931" className="redirect-button"><p>Saiba Mais</p></a>
                    </div>
            ...
            <div id="product-container">
                <div id="product">
                    ...
                    <a href="https://sibutina.com.br/?mcr=AXC11198354" className="redirect-button"><p>Saiba Mais</p></a>
                    </div>
                ...
                <div id="product">
                    ...
                    <a href="https://sinedrol.com.br/?mcr=ABQ11196298" className="redirect-button"><p>Saiba Mais</p></a>
                    </div>
            ...
            <div id="product-container">
                <div id="product">
                    ...
                    <a href="https://mon.net.br/11esvn" className="redirect-button"><p>Saiba Mais</p></a>
                    </div>
                ...
                <div id="product">
                    ...
                    <a href="http://mon.net.br/10j2f1" className="redirect-button"><p>Saiba Mais</p></a>
                    </div>
