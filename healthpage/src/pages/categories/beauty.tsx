    ...
    return (
        <div id="category-page">  
           ...
           <div id="product-container">
                ...
                <div id="product">
                <h4>Silk Skin</h4>
                    <a href="http://mon.net.br/11ens5"><img src="https://images.tcdn.com.br/img/img_prod/790926/6_cremes_6_colagenos_7_1_20200601102846.jpg" alt=""/></a>
                    <p className="prod-description">
                        O Silk Skin ( em português "pele de seda") é um creme usado no tratamento e diminuição das estrias. Proporciona bem-estar e sensação de firmeza na pele, previnindo também o surgimento de novas estrias. Produto testado dermatologicamente com eficácia comprovada em 28 dias.
                    </p>
                </div>
            </div>
            <div id="product-container">
            ...
            <div id="product-container">
                ...
                <div id="product">
                    <h4>Aparelho de Massagem e Fisioterapia</h4>
                    <a href="http://mon.net.br/11eteq"><img src="http://mundoshopbr.com.br/aparelho-ten-fes-obrigado/Aparelho-fisio-massagem.jpg" alt=""/></a>
                    <p className="prod-description">Este aparelho possui 8 funções para massagear e auxiliar na recuperação e regeneração de músculos e articulações.</p>
                </div>
            </div>
            <div id="product-container">
                <div id="product">
                ...
                <div id="product">
                    <h4>Hidraliso - Alisador de chuveiro</h4>
                    <a href="http://mon.net.br/11ewj9"><img src="https://miro.medium.com/max/2560/1*I4PEaSk5KRkkkfkLj7iKQA.jpeg" alt=""/></a>
                    <p className="prod-description">O queridinho das blogueiras, é um blend de aminoácidos rico em vitaminas B1 e B2, baixo PH e peso molecular, repositor de massa. O alisamento de chuveiro</p>
                </div>
            </div>
